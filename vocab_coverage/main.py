...
def main():
    ...
    cmdEmbedding.add_argument("--postfix", type=str, default='', help="图像文件名可选后缀，用以控制生成的文件名")
    ...
    cmdEmbedding.add_argument("--position", type=str, default='input', help="词向量的位置。可选项为 'input', 'output'，多选用逗号分隔，如：'input,output',（默认为 'input'）")
    cmdEmbedding.add_argument("--granularity", type=str, default='token', help="向量分析的颗粒度，可以为 'token'、'char'(汉字)、'word'(词)、'sentence'(句)，（默认为 'token'）")
